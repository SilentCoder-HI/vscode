...
export default function Welcome({ onOpenFile, onOpenFolder, onExtensions }: WelcomeProps) {
  return <section className="mx-auto max-w-5xl px-8 py-[9vh] sm:px-16">
    ...
    <div className="mt-8 flex flex-wrap gap-3">
      <button className="border border-[#e59b62] bg-[#e59b62] px-5 py-3 text-sm font-medium text-[#1e1e1e] transition hover:bg-[#f1b07b]" onClick={onOpenFolder}>Open folder <span className="ml-2">{'->'}</span></button>
      <button className="border border-[#4b5b52] px-5 py-3 text-sm text-[#d7dfd9] transition hover:border-[#e59b62] hover:text-[#f1b07b]" onClick={onOpenFile}>Open file</button>
